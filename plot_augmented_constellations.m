                    ...
                    for k=1:Ns
                        ...
                        for o=1:4
                            ...
                            case 1
                                disp('AGN');
                                xc=complex(I,Q);
                                sig_pow=(1/length(I))*sum(abs(xc).^2);
                                disp(sig_pow);
                                snr_wat=10^(5/10);
                                no=sig_pow/snr_wat;
                                std_val=sqrt(no/2);
                                gnoise=complex(std_val.*randn(length(I),1),std_val.*randn(length(I),1));
                                rxSamples=xc+gnoise;
                                i=real(rxSamples);
                                max_i=max(i);
                            ...
                            case 2
                                disp('Rotation')
                                pp=[cosd(30) -sind(30);sind(30) cosd(30)]*[I,Q]';
                                i=pp(1,:);
                                q=pp(2,:);
                                max_i=max(i);
                                max_q=max(q);
                            ...
                            case 3
                                ...
                                for rr=1:length(I)
                                    theta=rr*level;
                                    pp=[cosd(theta) -sind(theta);sind(theta) cosd(theta)]*[I(rr),Q(rr)]';
                                    i(rr)=pp(1,1);
                                    q(rr)=pp(2,1);
